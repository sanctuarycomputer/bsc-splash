...
var _mailshrimp = require('./mailshrimp');
...
var _contentEntrance = require('./contentEntrance');

var _contentEntrance2 = _interopRequireDefault(_contentEntrance);
...
var loadBackgroundImage = exports.loadBackgroundImage = function loadBackgroundImage(imageSrc) {
  var contentBack = $(".content-container").parent().get(0);
  return new _es6Promise2.default(function (resolve, reject) {
